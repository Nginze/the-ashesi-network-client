...
class PeopleQueryView extends ConsumerStatefulWidget {
  final String query;

  PeopleQueryView(this.query);
  @override
  _PeopleQueryViewState createState() => _PeopleQueryViewState();
}

class _PeopleQueryViewState extends ConsumerState<PeopleQueryView> {
  ...
  Future<void> _fetchData() async {
    List<dynamic> newSuggestions = await userService.search(widget.query);
      ...
      slivers: [
        ...
        SliverList(
          delegate: SliverChildBuilderDelegate(
            ...
            childCount:
                _isLoading ? suggestions.length + 1 : suggestions.length,
          ),
        ),
      ],
    );
